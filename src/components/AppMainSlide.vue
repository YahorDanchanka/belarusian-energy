  ...
  <div class="main-slide">
    ...
    <div style="overflow: hidden">
      <div class="main-slide__buttons">
        ...
        <BaseButton class="main-slide__button" to="/404" imageUrl="/images/icons/nuclear.png">Станции</BaseButton>
...
.main-slide
  ...
  background: #1E1E1E url(~assets/images/main-background.png) no-repeat center center / cover
  padding: 15px
  position: relative
...
.main-slide__buttons
  display: flex
  flex-wrap: wrap
  margin: 0 (-$buttonXIndent / 2) (-$buttonYIndent) (-$buttonXIndent / 2)
...
.main-slide__button
  width: calc(100% / 4 - #{$buttonXIndent})
  margin: 0 $buttonXIndent / 2 $buttonYIndent $buttonXIndent / 2

  +sm-block
    $buttonXIndent: 15px
    width: calc(100% / 2 - #{$buttonXIndent})
    margin: 0 $buttonXIndent / 2 $buttonYIndent $buttonXIndent / 2

  +xs-block
    $buttonXIndent: 15px
    $buttonYIndent: 10px
    width: calc(100% - #{$buttonXIndent})
    margin: 0 $buttonXIndent / 2 $buttonYIndent $buttonXIndent / 2
</style>
