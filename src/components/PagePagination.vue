<template>
  <div class="page__pagination pagination">
    <router-link
      ...
      exact-active-class="pagination__item_active"
      :to="{ name: 'find-the-station' }"
    >
      1
    </router-link>
...
.pagination__item:hover + .pagination__item-decor
  display: block

  +sm-block
    display: none

.pagination__item-decor
  position: absolute
