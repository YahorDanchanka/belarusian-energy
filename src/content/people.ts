...
export const people: People = [
  {
    ...
    content:
      'Без малого 40 лет Николай Анисимов отдал выбранной профессии, пройдя путь от инженера до управляющего энергосистемой Гомельской области. Как сказал генеральный директор “Гомельэнерго” Александр Петух на открытии мемориала, приходящее на смену поколение должно не только добросовестно трудиться, но и помнить своих предшественников.',
  },
  {
